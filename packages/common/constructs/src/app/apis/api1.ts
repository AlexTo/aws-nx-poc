...
import {
  OPERATION_DETAILS,
  Operations,
} from '../../generated/api1/metadata.gen.js';

/**
 * Properties for creating a Api1 construct
 *
 * @template TIntegrations - Map of operation names to their integrations
 */
export interface Api1Props<
  ...
  public static defaultIntegrations = (scope: Construct) => {
    ...
    return IntegrationBuilder.rest({
      ...
      buildDefaultIntegration: (op, props: FunctionProps) => {
        const handler = new Function(scope, `Api1${op}Handler`, props);
