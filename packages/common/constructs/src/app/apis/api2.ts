...
> extends RestApi<Operations, TIntegrations> {
  ...
  constructor(scope: Construct, id: string, props: Api2Props<TIntegrations>) {
    const authorizerFunction = new Function(scope, 'Api2AuthorizerFunction', {
      runtime: Runtime.PYTHON_3_14,
      handler: 'aws_nx_poc_api2.authorizer.handler',
      code: Code.fromAsset(
        url.fileURLToPath(
          new URL(
            '../../../../../../dist/packages/api2/bundle-x86',
    ...
    super(scope, id, {
      ...
      defaultMethodOptions: {
        ...
        authorizer: new TokenAuthorizer(scope, 'Api2TokenAuthorizer', {
