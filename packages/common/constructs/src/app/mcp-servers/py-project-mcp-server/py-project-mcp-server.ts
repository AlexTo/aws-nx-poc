...
export type PyProjectMcpServerProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class PyProjectMcpServer
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  public readonly mcpServerName = 'py-project-mcp-server';

  constructor(scope: Construct, id: string, props?: PyProjectMcpServerProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/py_project/docker/py-project-mcp-server',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'PyProjectMcpServer', {
    ...
    rc.set('agentcore', 'agentRuntimes', {
      ...
      PyProjectMcpServer: this.agentCoreRuntime.agentRuntimeArn,
    });
  }
