...
export class InventoryMcpServer
  extends Construct
  implements IGrantable, IConnectable
{
  ...
  constructor(scope: Construct, id: string, props?: InventoryMcpServerProps) {
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/inventory/bundle/mcp/inventory-mcp-server',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'InventoryMcpServer', {
    ...
    rc.set('agentcore', 'agentRuntimes', {
      ...
      InventoryMcpServer: this.agentCoreRuntime.agentRuntimeArn,
    });
  }
