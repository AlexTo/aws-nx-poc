...
export type AgentsMcpServerProps = Omit<
  RuntimeProps,
  | 'runtimeName'
  ...
  implements IGrantable, IConnectable
{
  ...
  constructor(scope: Construct, id: string, props?: AgentsMcpServerProps) {
    super(scope, id);
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/agents/bundle/mcp/agents-mcp-server',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'AgentsMcpServer', {
