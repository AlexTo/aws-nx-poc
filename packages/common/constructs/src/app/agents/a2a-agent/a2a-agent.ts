...
export type A2aAgentProps = Omit<
  RuntimeProps,
  | 'runtimeName'
...
export class A2aAgent extends Construct implements IGrantable, IConnectable {
  ...
  constructor(scope: Construct, id: string, props?: A2aAgentProps) {
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/agents/bundle/agent/a2a-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'A2aAgent', {
