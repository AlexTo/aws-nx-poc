...
export class MyAgent extends Construct implements IGrantable, IConnectable {
  ...
  constructor(scope: Construct, id: string, props?: MyAgentProps) {
    ...
    const bundleDir = path.join(
      ...
      'dist/packages/py_project/docker/my-agent',
    );
    ...
    this.agentCoreRuntime = new Runtime(this, 'MyAgent', {
