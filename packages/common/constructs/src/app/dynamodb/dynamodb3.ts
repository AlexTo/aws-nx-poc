...
import { PACKAGE_NAME, GLOBAL_SECONDARY_INDEXES } from ':aws-nx-poc/dynamodb3';
import { AttributeType, ProjectionType } from 'aws-cdk-lib/aws-dynamodb';
import { DynamoDBTable, DynamoDBTableProps } from '../../core/dynamodb.js';

export type Dynamodb3Props = Omit<DynamoDBTableProps, 'runtimeConfigKey'>;

export class Dynamodb3 extends DynamoDBTable {
  constructor(scope: Construct, id: string, props?: Dynamodb3Props) {
    super(scope, id, {
      ...props,
